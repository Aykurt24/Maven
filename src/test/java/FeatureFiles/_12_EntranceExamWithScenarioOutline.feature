...
#    try catch... if no such element exeption, then click random on the other element?#    try catch... if no such element exeption, then click random on the other element?